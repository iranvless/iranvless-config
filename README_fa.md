...
## به ایران ویلس خوش آمدید
ایران ویلس یک ابزار قدرتمند و حرفه‌ای برای باز کردن سایت های محدود شده در اینترنت ایران است که دارای پنل چند کاربره و نصب آسان است و به شما کمک می‌کند با **بیش از ۲۰ پروتکل پشتیبانی شده** شامل **ریالیتی** محدود اینترنت را دور بزنید همچنین می‌توانید از **پروکسی تلگرام** استفاده نمایید. این ابزار برای شبکه اینترنت **ایران** بهینه سازی شده است و توسط <a href="https://github.com/XTLS/Xray-core#installation" target="_blank">**Xray**</a> توصیه شده است. این پنل یک جایگزین عالی برای پنل X-UI می‌باشد.
...
***
### فهرست مطالب
- [چرا ایران ویلس؟](#%DA%86%D8%B1%D8%A7-%D9%87%DB%8C%D8%AF%DB%8C%D9%81%D8%A7%DB%8C)
  ...
  - [پروکسی هوشمند برای سایت های غیر ایرانی و محدود شده](#%D9%BE%D8%B1%D9%88%DA%A9%D8%B3%DB%8C-%D9%87%D9%88%D8%B4%D9%85%D9%86%D8%AF-%D8%A8%D8%B1%D8%A7%DB%8C-%D8%B3%D8%A7%DB%8C%D8%AA-%D9%87%D8%A7%DB%8C-%D8%BA%DB%8C%D8%B1-%D8%A7%DB%8C%D8%B1%D8%A7%D9%86%DB%8C-%D9%88-%D9%81%DB%8C%D9%84%D8%AA%D8%B1%D8%B4%D8%AF%D9%87)
...
۱. روش اول فقط سایت غیرقابل دسترسی را از وی پی ان عبور دهد.
...
<div align=center>
 ...
 [![tutorial](https://github.com/hiddify/hiddify-config/blob/main/docs/Tutorials_fa.webp)](https://github.com/iranvless/iranvless-config/wiki/home_fa)
 
<!--
<a href="https://github.com/iranvless/iranvless-config/wiki/Home_fa"><img width="40%" src="https://github.com/iranvless/iranvless-config/assets/125398461/6ce5d04f-d324-4e9a-9b64-41f2176e20c7" /></a>
-->
...
ما برای سرویس هایمان به کمک مالی هم نیاز داریم. تمامی فعالیت‌های ما به صورت داوطلبانه انجام می‌شود و حمایت‌های مالی صرف توسعه پروژه می‌شود. اطلاعات و آدرس‌های حمایت‌ از ما را در [این لینک](https://github.com/iranvless/iranvless-config/wiki/support) مشاهده فرمایید.
